    ...
    <div>
      ...
      {nav ? (
        <div className="fixed w-full h-screen bg-black/50 flex flex-col justify-center items-center z-20">
          <a
            href="#main"
            className="w-[75%] flex justify-center items-center rounded-xl border-2 border-white bg-accent m-2 p-4 cursor-pointer hover:scale-105 ease-in duration-200"
          >
      ...
      <div className="md:block hidden fixed top-[25%] z-10">
        <div className="flex flex-col">
          <a
            href="#main"
            className="rounded-full border-2 border-white bg-accent m-3 p-4 cursor-pointer hover:scale-105 ease-in duration-300"
          >
            <AiOutlineHome size={30} color="#3a4220" />
          </a>
          <a
